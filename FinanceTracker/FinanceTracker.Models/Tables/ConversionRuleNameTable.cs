...
namespace FinanceTracker.Models
{
    internal class ConversionRuleNameTable
    {
        ...
        {
            ConversionRuleNameModel conv = new ConversionRuleNameModel { Id = Guid.NewGuid(), AccountId = accId, Column = 0, UseAdvanced = false, AdvancedScript = "function GetName(splitTrans){\n\n}" };
